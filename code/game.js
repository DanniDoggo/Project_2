// Map each class of actor to a character (MOVING OBJECTS)
var actorChars = {
  "@": Player,
...
SpeedBoost.prototype.act = function(step){
  this.wobble += step * spWobbSpeed;
  var spWobbPos = Math.sin(this.wobble) * spWobbDist;
  this.pos = this.basePos.plus(new Vector (0, spWobbPos));
